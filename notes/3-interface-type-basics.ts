...
const x: StringOrNumber = 'element';
...
const peter: HasInternationalPhoneNumber = {
  name: 'peter',
  phone: 1457897,
  countryCode: 'aa12'
};
...
const foo: ContactMessenger2 = (asa, as) => {
  return 'something';
};

foo({ name: 'pepe', phone: 4778 }, 'pedro');
...
const z: StringVal = Math.random() > 0.5 ? 'b' : ['a']; // ✅ ok!
