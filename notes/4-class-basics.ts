...
class OtherContact implements HasEmail, HasPhoneNumber {
  ...
  private password!: string; // Definite assignment. Estamos garantizando que de una forma u otra, esta propiedad va a inicializarse con un valor
...
const pepe = new OtherContact('pepe', 'pepe@pepe.com', 645878);
